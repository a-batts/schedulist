...
Route::post('login/callback/onetap', [AuthController::class, 'handleOneTapCallback']);
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
  ...
  Route::get('settings/schedules', EditSchedules::class)->name('schedule-settings');
  ...
  Route::get('settings/account/manage-devices', LogoutOtherSessions::class)->middleware('haspassword')->name('account.manage-devices');
  Route::get('settings/account/set-password', UpdatePassword::class)->middleware('haspassword:not')->name('account.set-password');
  Route::get('settings/account/delete-account', DeleteAccount::class)->middleware('haspassword')->name('account.delete-account');
});
