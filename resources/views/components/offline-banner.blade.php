...
>
  <div class="mdc-card mdc-card--outlined md:w-96 p-4 py-6 rounded-lg fixed bottom-4 md:right-3 z-50 mdc-elevation--z10" x-show.transition="showingBanner" x-cloak>
    <div>
