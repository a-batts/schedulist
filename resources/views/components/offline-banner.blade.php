...
>
  <div class="mdc-card mdc-card--outlined mdc-elevation--z10 fixed bottom-4 z-50 rounded-lg p-4 py-6 md:right-3 md:w-96" x-transition x-show="showingBanner" x-cloak>
    <div>
      <div class="float-left ml-2 mt-0.5 text-xl font-bold"><i class="material-icons mr-4 align-top">signal_wifi_connected_no_internet_4</i> You are offline.</div>
