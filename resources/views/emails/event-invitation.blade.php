                    ...
                    <table class="content" role="presentation" style="width:600px; border-collapse:collapse; border:0px; text-align:left;">
                        ...
                        <tr>
                            <td style="padding:30px 0px 60px; text-align: center;">
                                <a href="{{$data['route']}}" class="button" style="display: inline-block; padding: 12px 25px; border-radius: 12px; font-weight: bold; cursor: pointer; text-decoration: none; font-size: 16px" target="_blank">View event</a>
                            </td>
                        </tr>
                        <tr>
