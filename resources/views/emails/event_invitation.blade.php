...
<![endif]-->
  ...
  <style type="text/css">
    ...
    td .es-button-border:hover a.es-button-2 {
    	background:#338ee9!important;
    	border-color:#338ee9!important;
    }
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-bottom:25px;font-size:0px"><a target="_blank" href="https://schedulist.xyz" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#1376C8;font-size:14px"><img src="https://pvwwfo.stripocdn.email/content/guids/CABINET_0655870c65b5665cc7ed66e8d996c820/images/60141626922089626.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="250"></a></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
             ...
             <tr>
              <td align="left" style="Margin:0;padding-left:40px;padding-right:40px;padding-top:35px;padding-bottom:35px">
               ...
               <table cellpadding="0" cellspacing="0" class="es-left" align="left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                 <tr>
                  <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;padding-top:20px;width:34px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr class="es-mobile-hidden">
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;font-size:0px"><img class="adapt-img" src="https://pvwwfo.stripocdn.email/content/guids/CABINET_0655870c65b5665cc7ed66e8d996c820/images/92641626909840802.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="25" height="25"></td>
                     </tr>
                   </table></td>
                 </tr>
               </table>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:598px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="Margin:0;padding-top:5px;padding-left:5px;padding-right:5px;padding-bottom:15px"><span class="es-button-border-3 es-button-border" style="border-style:solid;border-color:#2cb543;background:#1674d3;border-width:0px;display:inline-block;border-radius:5.4px;width:auto;margin-bottom:10px"><a href="{{$route}}" class="es-button es-button-2" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:16px;border-style:solid;border-color:#1674d3;border-width:10px 20px;display:inline-block;background:#1674d3;border-radius:7px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-weight:500;font-style:normal;line-height:19px;width:auto;text-align:center;box-shadow:#CCCCCC 0px 3px 1px -2px, #DBDBDB 0px 2px 2px 0px, #E0E0E0 0px 1px 5px 0px;letter-spacing:0.0892857em">VIEW EVENT</a></span></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:18px;color:#808080;font-size:12px"><span style="background-color:null">You received this email because an event invitation was sent to the Schedulist account linked to your email address. If you were not expecting an invitation, or you think you received this in error please ignore this email.</span></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
