    ...
    <x-slot name="content">
        ...
        <div class="email_margins mt-10" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            ...
            <div class="mt-5 mb-2 ml-2">
              <p class="text-error"><x-jet-input-error class="mdc-typograpy text-error" style="font-family: 'Roboto'; color: #B00020" for="confirmable_password"/></p>
            </div>

        </div>
        <button class="mdc-button mdc-button--raised mdc-button-ripple tfa-button mt-10 ml-3 mb-4" wire:click="confirmPassword" wire:loading.attr="disabled">
