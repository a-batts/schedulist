...
@hide-password-confirmation="passwordConfirmation = false">
    ...
    <div style="max-width: 600px">
        <ul class="w-full mt-2 mdc-deprecated-list mdc-deprecated-list--icon-list security-list ">
            <li class="border-b border-gray-200 security-list mdc-deprecated-list-item" tabindex="0" href="{{route('account.set-password')}}">
                <span class="-mt-0.5 text-gray-600 mdc-deprecated-list-item__graphic material-icons text-inherit" aria-hidden="true">
                    badge
                </span>
        ...
        <div class="rounded-md background-red">
            <div class="flex items-center px-4 py-4 text-sm sm:py-0">
                <div class="flex-none w-14 material-icons">history</div>                    
  ...
  <div class="fixed w-screen h-screen pb-6 overflow-y-auto top-12 modal-container" x-show.transition="passwordConfirmation" x-cloak wire:ignore.self>
    <div class="px-6 pt-6 mdc-card mdc-card--outlined modal-card">
        ...
        <div class="mt-5">
            <button class="float-right ml-4 mdc-button mdc-button-ripple mdc-button--raised" wire:click="" wire:ignore>
                <span class="mdc-button__ripple"></span>Confirm
            </button>
            <button class="float-right mdc-button mdc-button-ripple" @click="passwordConfirmation = false; undoFixBody()" wire:ignore wire:loading.attr="disabled">
                <span class="mdc-button__ripple"></span>Nevermind
            </button>
        </div>
    </div>
