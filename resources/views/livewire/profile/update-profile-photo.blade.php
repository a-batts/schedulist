<div x-data="updateProfilePhoto()" @open-photo-dialog.window="initPond(); photoPicker = true"
    ...
    <div class="fixed w-screen h-screen pb-6 overflow-y-auto modal-container mdc-typography top-12" x-show="photoPicker"
        ...
        <div class="mdc-card mdc-card--outlined modal-card">
            <div class="top-row-container">
                <div class="close-and-title">
                    <button class="float-left mdc-icon-button close-icon material-icons" type="button"
                        aria-describedby="close-profile-photo-modal" aria-label="close"
                        x-on:click="photoPicker = false">
            ...
            <div class="mx-auto -mt-8 text-center">
                ...
                <div class="px-12 mt-6 sm:px-16">
                    ...
                    <p class="mt-1 text-sm text-gray-500"><span class="inline-block"><span
                                class="inline-block mt-1 mr-3 align-text-bottom material-icons text-inherit"
            ...
            <div class="pb-6 mt-8 text-center" wire:ignore>
                <button class="inline-block mdc-button mdc-button--outlined mdc-button--icon-leading"
                ...
                <button
                    class="inline-block ml-2 mdc-button mdc-button--raised mdc-button-ripple mdc-button--icon-leading"
