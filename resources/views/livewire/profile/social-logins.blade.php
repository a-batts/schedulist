  ...
  description="Link a Google account to sign in to your account with just a single click.">
    <div class="pt-4 pb-2">
      ...
      <div class="float-right mt-3">
        <button class="float-left mdc-button mdc-button-ripple mdc-button--outlined loginG" @if($this->hasGoogleAccount) wire:click="disconnectGoogle" @else onclick="document.location='/login/google'" @endif>
