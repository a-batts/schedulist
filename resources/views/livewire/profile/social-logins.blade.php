        ...
        <div class="pt-4 pb-2">
            <div class="float-left">
                @if ($this->hasGoogleAccount)
                    ...
                    <p class="mt-2 text-sm text-gray-500">Linked to <span
                            class="font-medium">{{ Auth::user()->google_email }}</span></p>
                @else
            ...
            <div class="float-right mt-3">
                <button class="mdc-button mdc-button-ripple mdc-button--outlined google-signin float-left"
                    @if ($this->hasGoogleAccount) wire:click="disconnectGoogle" @else onclick="document.location='{{ route('google-login') }}'" @endif>
