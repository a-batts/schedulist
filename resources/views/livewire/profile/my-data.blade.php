        ...
        <div style="max-width: 600px">
            @if ($existingBackup != null)
                <div class="px-6 py-5 my-4 mdc-card mdc-card--outlined">
                    ...
                    <button class="mt-5 mdc-button mdc-button--raised mdc-button-ripple"
                    x-ref="redownloadButton"
                    @click="@this.redownload(); $refs.redownloadButton.innerHTML = 'Download is Processing'; $refs.redownloadButton.disabled = true" wire:ignore>
            ...
            <div class="flex items-center py-4 mt-5 border-t border-b border-gray-200">
                ...
                <div class="relative float-left ml-2 mr-4 mdc-checkbox mdc-checkbox--touch" wire:ignore>
                    <input type="checkbox"
                            class="mdc-checkbox__native-control" @click="toggleCategory('profile')" :checked="selectedData.includes('profile')">
            ...
            <div class="py-4 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="relative float-left ml-2 mr-4 mdc-checkbox mdc-checkbox--touch" wire:ignore>
                        <input type="checkbox"
                                class="mdc-checkbox__native-control" @click="toggleCategory('assignments')" :checked="selectedData.includes('assignments')" @if($user->assignments->count() < 1)disabled @endif>
                        <div class="mdc-checkbox__background">
                            <svg class="mdc-checkbox__checkmark"
                                viewBox="0 0 24 24">
                            <path class="mdc-checkbox__checkmark-path"
                ...
                <button class="mt-2 ml-12 mdc-button mdc-button-ripple" wire:click="deleteData('assignments')" x-ref="assignmentButton" @click="$refs.assignmentButton.disabled = true" wire:ignore @if($user->assignments->count() < 1)disabled @endif>
            ...
            <div class="py-4 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="relative float-left ml-2 mr-4 mdc-checkbox mdc-checkbox--touch" wire:ignore>
                        <input type="checkbox"
                                class="mdc-checkbox__native-control" @click="toggleCategory('classes')" :checked="selectedData.includes('classes')" @if($user->classes->count() < 1)disabled @endif>
                        <div class="mdc-checkbox__background">
                            <svg class="mdc-checkbox__checkmark"
                                viewBox="0 0 24 24">
                            <path class="mdc-checkbox__checkmark-path"
                ...
                <button class="mt-2 ml-12 mdc-button mdc-button-ripple" wire:click="deleteData('classes')" x-ref="classButton" @click="$refs.classButton.disabled = true" wire:ignore @if($user->classes->count() < 1)disabled @endif>
                    <span class="mdc-button__ripple"></span>Delete
                </button>
            </div>
            <div class="py-4 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500">All of the class schedules you've created. Download this along side your class data to determine when your classes took place.</p>
                    </div>
                    <div class="relative float-left ml-2 mr-4 mdc-checkbox mdc-checkbox--touch" wire:ignore>
                        <input type="checkbox"
                                class="mdc-checkbox__native-control" @click="toggleCategory('schedules')" :checked="selectedData.includes('schedules')" wire:ignore @if($user->schedules->count() < 1)disabled @endif>
                        <div class="mdc-checkbox__background">
                            <svg class="mdc-checkbox__checkmark"
                                viewBox="0 0 24 24">
                            <path class="mdc-checkbox__checkmark-path"
                ...
                <button class="mt-2 ml-12 mdc-button mdc-button-ripple" wire:click="deleteData('schedules')" x-ref="scheduleButton" @click="$refs.scheduleButton.disabled = true" wire:ignore @if($user->schedules->count() < 1)disabled @endif>
                    <span class="mdc-button__ripple"></span>Delete
                </button>
            </div>
            <div class="py-4 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="relative float-left ml-2 mr-4 mdc-checkbox mdc-checkbox--touch" wire:ignore>
                        <input type="checkbox"
                                class="mdc-checkbox__native-control" @click="toggleCategory('events')" :checked="selectedData.includes('events')" @if($user->events->count() < 1)disabled @endif>
                        <div class="mdc-checkbox__background">
                            <svg class="mdc-checkbox__checkmark"
                                viewBox="0 0 24 24">
                            <path class="mdc-checkbox__checkmark-path"
                ...
                <button class="mt-2 ml-12 mdc-button mdc-button-ripple" wire:click="deleteData('events')" x-ref="eventButton" @click="$refs.eventButton.disabled = true" wire:ignore @if($user->events->count() < 1)disabled @endif>
            ...
            <div class="mt-5">
                ...
                :disabled="selectedData.length < 1 || creatingArchive"
                x-ref="downloadButton"
                @click="@this.createArchive(); creatingArchive = true; $refs.downloadButton.innerHTML = 'Download is Processing'" wire:ignore>
        ...
        <div class="fixed top-0 z-40 flex items-center justify-center w-screen h-screen" x-transition x-show="downloadInProgress" x-cloak>
            <div class="flex-initial px-20 pt-10 pb-4 text-gray-500 w-50 h-30 mdc-card mdc-card--outlined">
                ...
                <div class="mt-5 -mx-14">
                    <a href="{{route('profile')}}" class="mt-5 mdc-button mdc-button--raised mdc-button-ripple tfa-button" wire:ignore>
                        <span class="mdc-button__ripple"></span>Done
                    </a>
                    <button class="mt-5 mr-4 mdc-button mdc-button-ripple tfa-button"
                    x-ref="redownload"
                    @click="@this.redownload(); $refs.redownload.disabled = true; setTimeout(() => $refs.redownload.disabled = false, 5000)" wire:ignore>
