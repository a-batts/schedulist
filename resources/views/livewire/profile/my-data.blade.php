...
@endpush
<div class="pt-20" x-data="dataManager()" @started-download.window="fixBody(); downloadInProgress = true"
    ...
    <x-ui.settings-card title="Manage Your Data" description="Backup or delete parts or all of your Schedulist data."
        ...
        <div style="max-width: 600px">
            @if ($existingBackup != null)
                <div class="mdc-card mdc-card--outlined px-6 py-5 my-4">
                    ...
                    <button class="mdc-button mdc-button--raised mdc-button-ripple mt-5" x-ref="redownloadButton"
