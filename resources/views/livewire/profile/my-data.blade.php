    ...
    back-button>
        <div style="max-width: 600px">
            ...
            <div class="py-4 border-b border-gray-200">
                ...
                <button class="mt-2 ml-12 mdc-button mdc-button-ripple" wire:click="deleteData('assignments')" x-ref="assignmentButton" x-on:click="$refs.assignmentButton.disabled = true" wire:ignore @if($user->assignments->count() < 1)disabled @endif>
            ...
            <div class="py-4 border-b border-gray-200">
                ...
                <button class="mt-2 ml-12 mdc-button mdc-button-ripple" wire:click="deleteData('classes')" x-ref="classButton" x-on:click="$refs.classButton.disabled = true" wire:ignore @if($user->classes->count() < 1)disabled @endif>
                    <span class="mdc-button__ripple"></span>Delete
                </button>
            </div>
            <!--
            <div class="py-4 border-b border-gray-200">
                ...
                <button class="mt-2 ml-12 mdc-button mdc-button-ripple">
                    <span class="mdc-button__ripple"></span>Delete
                </button>
            </div>
            -->
            <div class="py-4 border-b border-gray-200">
                ...
                <button class="mt-2 ml-12 mdc-button mdc-button-ripple" wire:click="deleteData('events')" x-ref="eventButton" x-on:click="$refs.eventButton.disabled = true" wire:ignore @if($user->events->count() < 1)disabled @endif>
            ...
            <div class="flex-initial px-20 pt-10 pb-4 text-gray-500 w-50 h-30 mdc-card mdc-card--outlined">
                <div>
                    <p class="text-center text-9xl">
                        <span class="text-gray-500 select-none text-9xl material-icons text-inherit">downloading</span>
                    </p>
