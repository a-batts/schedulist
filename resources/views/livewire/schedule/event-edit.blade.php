  <div class="mdc-typography" x-data="eventEdit()" @edit-event.window="editEvent(event.detail.id)"
      ...
      <x-ui.modal class="top-4" title="Edit Event" bind="modal">
          <x-slot name="actions">
              <button class="mdc-button mdc-button--raised mdc-button-ripple" type="button" @click="submit()">
          ...
          <label class="mdc-text-field mdc-text-field--filled w-full"
              ...
              <span class="mdc-floating-label mdc-floating-label--float-above" id="event-name-label">Title</span>
              ...
              <div class="w-full">
                  <div class="mdc-select mdc-select--filled w-full">
                      <div class="mdc-select__anchor">
                          ...
                          <span class="mdc-select__selected-text-container">
                              <span class="mdc-select__selected-text">{{ $event->category->name ?? '' }}</span>
                          </span>
                          <span class="mdc-select__dropdown-icon">
                              <svg class="mdc-select__dropdown-icon-graphic" viewBox="7 10 10 5" focusable="false">
                                  <polygon class="mdc-select__dropdown-icon-inactive" stroke="none" fill-rule="evenodd"
                      ...
                      <div class="mdc-select__menu mdc-menu mdc-menu-surface mdc-menu-surface--fullwidth">
                          <ul class="mdc-deprecated-list dark-theme-list">
                              @foreach ($categories as $category)
                                  <li class="mdc-deprecated-list-item @if ($category['value'] == $event->category) mdc-deprecated-list-item--selected @endif"
