  <div class="mdc-typography" x-data="eventEdit()" @update-content.window="updateContent($wire)"
      ...
      <x-ui.modal class="top-4" title="Edit Event" bind="modal">
          ...
          <div class="mdc-select mdc-select--filled w-4/5" wire:ignore.self>
              <div class="mdc-select__anchor">
                  ...
                  <span class="mdc-select__selected-text-container">
                      <span class="mdc-select__selected-text">{{ $event?->category?->formattedName() }}</span>
                  </span>
              ...
              <div class="mdc-select__menu mdc-menu mdc-menu-surface mdc-menu-surface--fullwidth">
                  <ul class="mdc-deprecated-list dark-theme-list">
                      @foreach ($categories as $category)
                          <li class="mdc-deprecated-list-item @if ($event?->category?->value == $category['value']) mdc-deprecated-list-item--selected @endif"
                              data-value="{{ $category['value'] }}" wire:click="setCategory({{ $category['value'] }})">
