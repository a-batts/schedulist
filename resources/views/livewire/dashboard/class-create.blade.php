 ...
 @close-add-diag="dialog = false">
  <div class="fab_button">
    <button class="mdc-fab mdc-fab--extended mdc-button-ripple" aria-label="Add Class" @click="reset()" wire:offline.attr="disabled">
      <div class="mdc-fab__ripple"></div>
      <span class="material-icons mdc-fab__icon">add</span>
      <span class="mdc-fab__label">Add Class</span>
    </button>
  </div>
  <x-ui.modal bind="dialog" title="New Class" class="top-3 bottom-3">
    <x-slot name="actions">
    ...
    <div class="flex w-full space-x-3">
      <div class="w-full">
        <label class="w-full mdc-text-field mdc-text-field--filled" :class="{'mdc-text-field--invalid': errorMessages['class.name'] != undefined}" wire:ignore>
      ...
      <div class="w-full">
        <label class="w-full mdc-text-field mdc-text-field--filled" :class="{'mdc-text-field--invalid': errorMessages['class.location'] != undefined}" wire:ignore>
          <span class="mdc-text-field__ripple"></span>
          <span class="mdc-floating-label" id="new-class-location-label">Location</span>
          <input class="mdc-text-field__input" wire:model.lazy="class.location" type="text" aria-labelledby="new-class-location-label">
          <span class="mdc-line-ripple"></span>
        </label>
    ...
    <div class="flex w-full space-x-3">
      <div class="w-full">
        <label class="w-full mdc-text-field mdc-text-field--filled" :class="{'mdc-text-field--invalid': errorMessages['class.teacher'] != undefined}" wire:ignore>
          <span class="mdc-text-field__ripple"></span>
      ...
      <div class="w-full">
        <label class="w-full mdc-text-field mdc-text-field--filled" :class="{'mdc-text-field--invalid': errorMessages['class.teacher_email'] != undefined}" wire:ignore>
          <span class="mdc-text-field__ripple"></span>
    ...
    <label class="w-full mdc-text-field mdc-text-field--filled" :class="{'mdc-text-field--invalid': errorMessages['class.video_link'] != undefined}" wire:ignore>
      <span class="mdc-text-field__ripple"></span>
    ...
    <div class="ml-1 text-base font-medium text-primary">Color</div>
            ...
            <div class="flex flex-grow space-x-3">
              <div class="basis-1/3">
                <label class="w-full mdc-text-field mdc-text-field--filled" :class="{'mdc-text-field--invalid': errorMessages['links.' + index + '.link']}" wire:ignore>
                  ...
                  <input class="mdc-text-field__input" type="text" :aria-labelledby="`link-${index}-name`" @keyup="links[index]['name'] = $el.value">
                  <span class="mdc-line-ripple"></span>
                </label>
              ...
              <div class="basis-2/3">
                <label class="w-full mdc-text-field mdc-text-field--filled" :class="{'mdc-text-field--invalid': errorMessages['links.' + index + '.link']}" wire:ignore>
                  ...
                  <input class="mdc-text-field__input" type="text" :aria-labelledby="`link-${index}-url`" @keyup="links[index]['link'] = $el.value">
                  <span class="mdc-line-ripple"></span>
                </label>
                <div class="mdc-text-field-helper-text mdc-text-field-helper-text--validation-msg mdc-text-field-helper-text--persistent text-error ml-1 mt-0.5 mb-0.5 h-6" aria-hidden="true">
