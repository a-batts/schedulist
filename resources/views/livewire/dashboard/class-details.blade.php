                            ...
                            <div class="-mr-2">
                                <a :class="{ 'pointer-events-none': classData?.[selectedClass]?.['teacher_email'] == null }"
                                    ...
                                    <button class="mdc-icon-button material-icons"
                                        :disabled="classData?.[selectedClass]?.['teacher_email'] == null" wire:ignore>
                                        <div class="mdc-icon-button__ripple"></div>
                                        email
                                    </button>
                                </a>
                                        ...
                                        <span class="mdc-evolution-chip" role="row"
                                            ...
                                            <span class="mdc-evolution-chip__cell mdc-evolution-chip__cell--primary"
                                                ...
                                                <a class="mdc-evolution-chip__action mdc-evolution-chip__action--primary"
                                                    ...
                                                    <span
                                                        class="mdc-evolution-chip__icon mdc-evolution-chip__icon--leading material-icons inline-block mr-2">link</span>
                        ...
                        <div class="lg:pr-5">
                            <template x-if="!classData?.[selectedClass]?.['schedule_id']">
                                <div class="mt-1">
                                    ...
                                    <div class="mdc-select mdc-select--filled w-full mt-6" wire:ignore>
                                    ...
                                    <div class="pt-3 space-y-3" x-show="addTime" x-transition.origin.top x-cloak>
                                        <div class="mdc-select mdc-select--filled w-full" wire:ignore>
                                            <div class="mdc-select__anchor" role="button" aria-haspopup="listbox"
                                                aria-expanded="false">
                                                <span class="mdc-select__ripple"></span>
                                                <span class="mdc-floating-label mdc-floating-label--float-above">Day of
                                                    week</span>
                                                <span class="mdc-select__selected-text-container">
                                                    <span class="mdc-select__selected-text"></span>
                                                </span>
                                        ...
                                        <div>
                                            <a :href="'/assignments/assignment/' + assignment.url_string">
                                                <div class="mdc-card mdc-card--outlined mt-3">
                                                    <div class="mdc-card__primary-action assignment-card-dashboard flex px-5 truncate"
                                                        tabindex="0">
                                                        <div class="flex-grow">
                                                            ...
                                                            <p class="mt-1 text-sm"
                                                                ...
                                                                Due <span x-text="assignment.human_due"></span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
