<x-guest-layout title="Login">
  <x-jet-authentication-card>
    ...
    <h2 class="mdc-typography logintext">Sign in</h2>
    ...
    x-data="{
      ...
      <div class="mt-5 mb-2">
        <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-trailing-icon login-form @error('email') mdc-text-field--invalid @enderror">
      ...
      <div class="flex items-center justify-end mt-4 forgotPassword">
        <a class="text-sm roboto text-blue" href="{{ route('password.request') }}">Forgot password?</a>
      </div>
    ...
    <div class="mdc-typography continue_with">
      <p>OR SIGN IN WITH</p>
    </div>
