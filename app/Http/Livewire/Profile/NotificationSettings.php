        ...
        switch ($component) {
            case 'account_alert_texts':
                if ($userSettings->account_alert_texts === false) {
                    $message =
                        'SMS account alerts were just disabled for your Schedulist account. If this wasn\'t you, reset your password ASAP.';
            ...
            case 'account_alert_emails':
                if ($userSettings->account_alert_emails === false) {
                    $data = [
                        ...
                        'body' =>
                            'Email security alerts for your Schedulist account were just disabled. If you didn\'t perform this action, your account may be compromised.',
                        'link' => route('profile'),
                        'link_title' => 'Go to account settings',
                        'footer' =>
                            'You received this email because you turned on email alerts for account updates.',
                        'subject' =>
                            'Security alert - Account status emails disabled',
                        'icon' => 'security',
                    ];
                    NotifyUser::createNotification(
                        $data,
