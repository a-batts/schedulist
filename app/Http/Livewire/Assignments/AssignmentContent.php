...
class AssignmentContent extends Component
{
    ...
    {
        $this->assignment = Assignment::where(
            'url_string',
            $this->urlString
        )->first();
    ...
    public function toggleCompletion(): void
    {
        ...
        $this->emit(
            'toastMessage',
            'Marked assignment as ' . strtolower($assignment->status->name)
        );
    }
    ...
    public function render()
    {
        ...
        $this->preview =
            $this->assignment->link_description == null ||
            $this->assignment->link_image == null
                ? $this->preview->withoutExisting()
                : $this->preview->withExisting(
                    $this->assignment->link_image,
                    $this->assignment->link_description
                );

        return view('livewire.assignments.assignment-content')->with(
            'preview',
            $this->preview
        );
    }
