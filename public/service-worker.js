    ...
    (() => {
        ...
        function l(e, s, n) {
            ...
            if ('string' == typeof e) {
                ...
                0;
                i = new a(({ url: e }) => e.href === t.href, s, n);
            } else if (e instanceof RegExp) i = new r(e, s, n);
            ...
            _useDefaultCacheabilityPluginIfNeeded() {
                ...
                for (const [s, n] of this.plugins.entries())
                    n !== N.copyRedirectedCacheableResponsesPlugin &&
                        (n === N.defaultPrecacheCacheabilityPlugin && (e = s),
                        n.cacheWillUpdate && t++);
                0 === t
        ...
        class M {
            constructor(e) {
                (this.cacheWillUpdate = async ({ response: e }) =>
                    ...
                    (this._cacheableResponse = new K(e));
            }
        }
        function A(e) {
            e.then(() => {});
        ...
        function G(e) {
            return e !== IDBDatabase.prototype.transaction ||
                ...
                ? (
                    ...
                    ? function (...t) {
                          return e.apply(z(this), t), J(B.get(this));
                      }
                    : function (...t) {
                          return J(e.apply(z(this), t));
                      }
                : function (t, ...s) {
                      const n = e.call(z(this), t, ...s);
                      return F.set(n, t.sort ? t.sort() : [t]), J(n);
                  };
        }
        function Q(e) {
        ...
        $ = ((e) => ({
            ...e,
            get: (t, s, n) => ee(t, s) || e.get(t, s, n),
            has: (t, s) => !!ee(t, s) || e.has(t, s),
        }))($);
        s(550);
        const te = 'cache-entries',
            se = (e) => {
                const t = new URL(e, location.href);
        ...
        class ne {
            ...
            _upgradeDb(e) {
                const t = e.createObjectStore(te, { keyPath: 'id' });
            ...
            async setTimestamp(e, t) {
                const s = {
                    ...
                    n = (await this.getDb()).transaction(te, 'readwrite', {
                        durability: 'relaxed',
                    });
            ...
            async getTimestamp(e) {
                const t = await this.getDb(),
                    s = await t.get(te, this._getId(e));
            ...
            async expireEntries(e, t) {
                ...
                const i = [];
                for (const e of a) await s.delete(te, e.id), i.push(e.url);
                return i;
            }
            _getId(e) {
                return this._cacheName + '|' + se(e);
            }
            async getDb() {
                return (
                    this._db ||
        ...
        class re {
            ...
            _getCacheExpiration(e) {
                if (e === p()) throw new t('expire-custom-caches-only');
                let s = this._cacheExpirations.get(e);
                return (
                    s ||
                        ((s = new ae(e, this._config)),
        ...
        (function (e) {
            ...
            [
                {
                    revision: '279705f147367afd4af61b058f9ce9d8',
                    url: '/js/bundle.js',
                },
                {
                    revision: '6531baddaf6ee4b90af9a03ea44855a5',
                    url: '/js/bundle.js.LICENSE.txt',
                },
                {
                ...
                {
                    revision: '0b073a0e3fe40391f209bdbc82eafdc6',
                    url: 'css/app.css',
                },
                {
                    revision: '4e6819e4a221e8906b47e29c56e4ed14',
                    url: 'css/bundle.css',
                },
                {
                    revision: '3d7a578da3d8bb1c1994e6f1c49ea254',
                    url: 'css/filament.css',
                },
                {
                    revision: 'null',
                    url: 'https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js',
                },
                { revision: '100', url: 'site.webmanifest' },
            ] || []
        ),
            (function (e) {
                const t = P();
            ...
            self.addEventListener('install', function (e) {
                ...
                e.waitUntil(
                    caches.open('pages').then(function (e) {
                        return e.addAll(t);
                    })
                );
            }),
            ...
            }, new C({ cacheName: 'google-fonts-stylesheets' })),
            l(function (e) {
                return 'https://fonts.gstatic.com' === e.url.origin;
            }, new R({
                cacheName: 'google-fonts-webfonts',
                plugins: [
                    new M({ statuses: [0, 200] }),
                    new re({ maxAgeSeconds: 31536e3, maxEntries: 30 }),
                ],
            })),
            l(
                function (e) {
                    return e.url.pathname.startsWith('/admin');
                },
                new (class extends v {
                    constructor(e = {}) {
                        super(e),
                    ...
                    async _handle(e, s) {
                        ...
                        try {
                            ...
                            if (this._networkTimeoutSeconds) {
                                const e = y(1e3 * this._networkTimeoutSeconds);
                                t.push(e);
                            }
            ...
            l(
                function (e) {
                    ...
                    return (
                        ...
                        ('' === t.destination &&
                            'cors' === t.mode &&
                            null !== t.headers.get('Turbolinks-Referrer'))
                    );
                },
                new (class extends v {
                    constructor(e = {}) {
                    ...
                    async _handle(e, s) {
                        ...
                        const o = await s.waitUntil(
                            (async () =>
                                (await s.waitUntil(Promise.race(a))) ||
                                (await i))()
                        );
            ...
            addEventListener('message', function (e) {
                e.data && 'SKIP_WAITING' === e.data.type && skipWaiting();
            }),
            l(function (e) {
                ...
                plugins: [
                    new M({ statuses: [200] }),
                    new re({ maxEntries: 50, maxAgeSeconds: 2592e3 }),
                ],
            })),
            (oe = function (e) {
                return 'document' === e.event.request.destination
                    ? caches.match('/offline')
                    : Response.error();
            }),
            h().setCatchHandler(oe);
    })();
})();
