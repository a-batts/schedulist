...
self.addEventListener('install', function (event) {
  var urls = ['/contact', '/privacy-policy', '/assignments', '/app', '/agenda', '/settings/account', '/settings/theme', '/offline'];
  var cacheName = 'pages';
