...
/* harmony import */ var workbox_recipes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! workbox-recipes */ "./node_modules/workbox-recipes/index.mjs");
...
(0,workbox_precaching__WEBPACK_IMPORTED_MODULE_2__.precacheAndRoute)([{'revision':'null','url':'/images/icon/vendor/google.png'},{'revision':'null','url':'/images/plane.svg'},{'revision':'a2fb6a779988800e03a114b372ea42b2','url':'/js/bundle.js'},{'revision':'ed16351585df23c5fc0c15f3f49b3c4b','url':'/js/turbo.js'},{'revision':'7dbab525e6690375a2a82cf5f2d15bf6','url':'css/bundle.css'},{'revision':'c9ab398d64f9652024afe0d941bf7d24','url':'css/filament.css'},{'revision':'b378fc64852228457445a0a2857db633','url':'css/styles.css'},{'revision':'null','url':'https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js'},{'revision':'null','url':'https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.8.0/dist/alpine.min.js'},{'revision':'null','url':'https://cdn.jsdelivr.net/gh/livewire/turbolinks@v0.1.x/dist/livewire-turbolinks.js'},{'revision':'null','url':'https://cdn.jsdelivr.net/gh/livewire/vue@v0.3.x/dist/livewire-vue.js'},{'revision':'null','url':'https://cdn.jsdelivr.net/npm/alpine-turbo-drive-adapter@1.0.x/dist/alpine-turbo-drive-adapter.min.js'},{'revision':'null','url':'https://cdn.jsdelivr.net/npm/vue@2.6.12/dist/vue.min.js'},{'revision':'null','url':'https://cdn.jsdelivr.net/npm/vuetify@2.x/dist/vuetify.min.js'},{'revision':'100','url':'site.webmanifest'}] || []);
...
self.addEventListener('install', function (event) {
  var urls = ['/contact', '/privacy-policy', '/assignments', '/app', '/agenda', '/user/profile', '/user/theme', '/offline'];
  var cacheName = 'pages';
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(function (_ref) {
  var url = _ref.url;
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(function (_ref2) {
  var url = _ref2.url;
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(function (_ref3) {
  var url = _ref3.url;
  return url.pathname.startsWith('/admin');
}, new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.NetworkOnly()); // Cache page navigations (html) with a Network First strategy
...
function (_ref4) {
  ...
  return request.mode === 'navigate' || request.destination === "" && request.mode === "cors" && request.headers.get('Turbolinks-Referrer') !== null;
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.setCatchHandler)(function (_ref7) {
